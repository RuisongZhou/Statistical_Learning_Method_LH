...
def train(trainset, train_labels):
    ...
    #     prior_probability[i] = np.sum(train_labels == i)
    ...
    for i in range(class_num):
        for j in range(feature_len):
            ...
            # 计算0，1像素点对应的条件概率
            probalility_0 = (float(pix_0)/float(pix_0+pix_1))*10000
            #乘以10000这么做是防止概率相乘时候趋近0造成很大误差，同时增大误差
            probalility_1 = (float(pix_1)/float(pix_0+pix_1))*10000
